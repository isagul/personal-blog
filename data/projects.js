export const myProjects = [
    {
        ...
        detail: 'A shopping cart project which lists books. It also allows you adding into basket and deleting item from basket by using react hooks, context-api, nodejs and mongodb. Also, you can sign up and log in into this app anymore and you can add books to your cart permanently.',
        npm_link: null
    },
    {
